...
for ss = 1:length(sub_labels) % subjects/ses/acq
    ...
    for rr = 1:length(run_nrs{ss}) % runs        
        ...
        ni1.fname = [save_name_base '_PPGtrigResponse_S0.nii.gz'];
        ...
        ni1.fname = [save_name_base '_PPGtrigResponse_std_S0.nii.gz'];
        niftiWrite(ni1,fullfile(save_dir,ni1.fname))
        clear ni1
        ...
        ni1.fname = [save_name_base '_PPGtrigResponse_odd_S0.nii.gz'];
        niftiWrite(ni1,fullfile(save_dir,ni1.fname))
        clear ni1
        ...
        ni1.fname = [save_name_base '_PPGtrigResponse_even_S0.nii.gz'];
        niftiWrite(ni1,fullfile(save_dir,ni1.fname))
        clear ni1
